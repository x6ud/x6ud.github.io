...
`,[s("children-placeholder",`
 ...
 cursor: not-allowed;
 opacity: .5;
 `)])]);const Ta=Object.assign(Object.assign({},we.props),{size:{type:String,default:"medium"},value:{type:[String,Number,Boolean],default:void 0},loading:Boolean,defaultValue:{type:[String,Number,Boolean],default:!1},disabled:{type:Boolean,default:void 0},round:{type:Boolean,default:!0},"onUpdate:value":[Function,Array],onUpdateValue:[Function,Array],checkedValue:{type:[String,Number,Boolean],default:!0},uncheckedValue:{type:[String,Number,Boolean],default:!1},onChange:[Function,Array]});var La=O({name:"Switch",props:Ta,setup(e){const{mergedClsPrefixRef:o}=Ve(e),i=we("Switch","Switch",Ea,Ma,e,o),r=Ie(e),{mergedSizeRef:l,mergedDisabledRef:n}=r,d=b(e.defaultValue),g=Xe(e,"value"),m=De(g,d),h=b(!1);function y(v){const{"onUpdate:value":p,onChange:u,onUpdateValue:z}=e,{nTriggerFormInput:N,nTriggerFormChange:x}=r;p&&T(p,v),z&&T(z,v),u&&T(u,v),d.value=v,N(),x()}function _(){const{nTriggerFormFocus:v}=r;v()}function $(){const{nTriggerFormBlur:v}=r;v()}function S(){n.value||(m.value!==e.checkedValue?y(e.checkedValue):y(e.uncheckedValue))}function L(){_()}function D(){$(),h.value=!1}function R(v){v.code==="Space"&&(y(!m.value),h.value=!1)}function M(v){v.code==="Space"&&(v.preventDefault(),h.value=!0)}return{handleClick:S,handleBlur:D,handleFocus:L,handleKeyup:R,handleKeydown:M,pressed:h,mergedClsPrefix:o,mergedValue:m,mergedDisabled:n,cssVars:J(()=>{const{value:v}=l,{self:{opacityDisabled:p,railColor:u,railColorActive:z,buttonBoxShadow:N,buttonColor:x,boxShadowFocus:B,loadingColor:C,textColor:j,[q("buttonHeight",v)]:E,[q("buttonWidth",v)]:Y,[q("buttonWidthPressed",v)]:le,[q("railHeight",v)]:X,[q("railWidth",v)]:te,[q("railBorderRadius",v)]:de,[q("buttonBorderRadius",v)]:ne},common:{cubicBezierEaseInOut:fe}}=i.value,ke=Fe((Z(X)-Z(E))/2),ze=Fe(Math.max(Z(X),Z(E))),$e=Z(X)>Z(E)?te:Fe(Z(te)+Z(E)-Z(X));return{"--bezier":fe,"--button-border-radius":ne,"--button-box-shadow":N,"--button-color":x,"--button-width":Y,"--button-width-pressed":le,"--button-height":E,"--height":ze,"--offset":ke,"--opacity-disabled":p,"--rail-border-radius":de,"--rail-color":u,"--rail-color-active":z,"--rail-height":X,"--rail-width":te,"--width":$e,"--box-shadow-focus":B,"--loading-color":C,"--text-color":j}})}},render(){const{mergedClsPrefix:e,mergedValue:o,mergedDisabled:i,checkedValue:r,$slots:l}=this,n=o===r,{checked:d,unchecked:g}=l;return c("div",{role:"switch","aria-checked":n,class:[`${e}-switch`,n&&`${e}-switch--active`,i&&`${e}-switch--disabled`,this.round&&`${e}-switch--round`,this.pressed&&`${e}-switch--pressed`],tabindex:this.mergedDisabled?void 0:0,style:this.cssVars,onClick:this.handleClick,onFocus:this.handleFocus,onBlur:this.handleBlur,onKeyup:this.handleKeyup,onKeydown:this.handleKeydown},c("div",{class:`${e}-switch__rail`,"aria-hidden":"true"},(d||g)&&c("div",{"aria-hidden":!0,class:`${e}-switch__children-placeholder`},c("div",{class:`${e}-switch__rail-placeholder`},c("div",{class:`${e}-switch__button-placeholder`}),d==null?void 0:d()),c("div",{class:`${e}-switch__rail-placeholder`},c("div",{class:`${e}-switch__button-placeholder`}),g==null?void 0:g())),c("div",{class:`${e}-switch__button`},c(Yo,{name:"fade-in-scale-up-transition"},{default:()=>this.loading?c(ko,{key:"loading",clsPrefix:e,strokeWidth:20}):null}),d&&c("div",{key:"checked",class:`${e}-switch__checked`},d()),g&&c("div",{key:"unchecked",class:`${e}-switch__unchecked`},g()))))}}),Na=O({components:{NSpin:zo,NSwitch:La},props:{landmarks:Array,imgUrl:String},setup(e){const o=b(),i=b();let r,l=b(!1),n;const d=b(!0);xe(async function(){r=i.value.getContext("2d"),await g()}),_e([()=>e.landmarks,()=>e.imgUrl,d],g);async function g(){var _;const m=o.value.getBoundingClientRect(),h=m.width,y=m.height;if((i.value.width!==h||i.value.height!==y)&&(i.value.width=h,i.value.height=y),r.clearRect(0,0,h,y),e.imgUrl){if(!n||n.src!==e.imgUrl)try{l.value=!0,n=await je(e.imgUrl)}finally{l.value=!1}let $=1;n.width>h&&($=h/n.width),n.height>y&&($=Math.min($,y/n.height));const S=h/2,L=y/2,D=n.width*$,R=n.height*$,M=S-D/2,v=L-R/2;if(r.drawImage(n,M,v,D,R),((_=e.landmarks)==null?void 0:_.length)===$o&&d.value){let p=function(B){r.beginPath();const C=e.landmarks[B].point,j=C[0]*D+M,E=C[1]*R+v;r.moveTo(j,E),N+=1,x+=e.landmarks[B].visibility},u=function(B){const C=e.landmarks[B].point,j=C[0]*D+M,E=C[1]*R+v;r.lineTo(j,E),N+=1,x+=e.landmarks[B].visibility},z=function(){const B=x/N||0,C=Math.floor(255*B),j=0,E=Math.floor(255*(1-B));r.strokeStyle=`rgb(${C},${j},${E})`,r.stroke(),N=0,x=0};r.lineWidth=1.5;let N=0,x=0;p(8),u(6),u(5),u(4),u(0),u(1),u(2),u(3),u(7),z(),p(10),u(9),z(),p(12),u(24),u(23),u(11),u(12),z(),p(12),u(14),u(16),z(),p(11),u(13),u(15),z(),p(24),u(26),u(28),z(),p(23),u(25),u(27),z(),p(16),u(18),u(20),u(16),u(22),z(),p(15),u(17),u(19),u(15),u(21),z(),p(28),u(32),u(30),u(28),z(),p(27),u(29),u(31),u(27),z()}}}return{wrapper:o,canvas:i,imageLoading:l,drawLandmarks:d}}});const Va={class:"normalized-landmarks-canvas",ref:"wrapper"},Da={ref:"canvas"};function Ia(e,o,i,r,l,n){const d=W("n-spin"),g=W("n-switch");return G(),ue("div",Va,[w(d,{show:e.imageLoading},{default:V(()=>[k("canvas",Da,null,512)]),_:1},8,["show"]),w(g,{value:e.drawLandmarks,"onUpdate:value":o[0]||(o[0]=m=>e.drawLandmarks=m),style:{position:"absolute",right:"4px",top:"4px","z-index":"2"}},null,8,["value"])],512)}var Ua=Ee(Na,[["render",Ia]]);const Qe=[0,1,0];class Wa{constructor(){ae(this,"_matrix",new Float32Array(16));ae(this,"_position",new Float32Array([0,0,0]));ae(this,"_quaternion",Ke(new Float32Array(4),0,0,0));ae(this,"_scale",new Float32Array([1,1,1]));ae(this,"matrixNeedsUpdate",!0)}updateMatrix(){So(this._matrix,this._quaternion,this._position,this._scale),this.matrixNeedsUpdate=!1}get matrix(){return this.matrixNeedsUpdate&&this.updateMatrix(),this._matrix}set matrix(o){this._matrix.set(o),Ae(this._position,this._matrix),Pe(this._quaternion,this._matrix),Me(this._scale,this._matrix),this.matrixNeedsUpdate=!1}get x(){return this._position[0]}set x(o){o!==this._position[0]&&(this._position[0]=o,this.matrixNeedsUpdate=!0)}get y(){return this._position[1]}set y(o){o!==this._position[1]&&(this._position[1]=o,this.matrixNeedsUpdate=!0)}get z(){return this._position[2]}set z(o){o!==this._position[2]&&(this._position[2]=o,this.matrixNeedsUpdate=!0)}get position(){return this._position}set position(o){qe(o,this._position)||(this._position.set(o),this.matrixNeedsUpdate=!0)}get scaleX(){return this._scale[0]}set scaleX(o){o!==this._scale[0]&&(this._scale[0]=o,this.matrixNeedsUpdate=!0)}get scaleY(){return this._scale[1]}set scaleY(o){o!==this._scale[1]&&(this._scale[1]=o,this.matrixNeedsUpdate=!0)}get scaleZ(){return this._scale[2]}set scaleZ(o){o!==this._scale[2]&&(this._scale[2]=o,this.matrixNeedsUpdate=!0)}get scale(){return this._scale}set scale(o){qe(o,this._scale)||(this._scale.set(o),this.matrixNeedsUpdate=!0)}get quaternion(){return this._quaternion}set quaternion(o){Ro(o,this._quaternion)||(this._quaternion.set(o),this.matrixNeedsUpdate=!0)}setRotationDegrees(o,i,r){Ke(this._quaternion,o,i,r),this.matrixNeedsUpdate=!0}rotateX(o){Bo(this._quaternion,this._quaternion,o),this.matrixNeedsUpdate=!0}rotateY(o){Fo(this._quaternion,this._quaternion,o),this.matrixNeedsUpdate=!0}rotateZ(o){Ao(this._quaternion,this._quaternion,o),this.matrixNeedsUpdate=!0}lookAt(o,i,r=Qe){Po(this._matrix,o,i,r),Ae(this._position,this._matrix),Pe(this._quaternion,this._matrix),Me(this._scale,this._matrix),this.matrixNeedsUpdate=!0}targetTo(o,i,r=Qe){Mo(this._matrix,o,i,r),Ae(this._position,this._matrix),Pe(this._quaternion,this._matrix),Me(this._scale,this._matrix),this.matrixNeedsUpdate=!0}}function K(...e){const o=[];for(let i=0,r=e.length;i<r-1;++i)o.push(e[i]),o.push(e[i+1]);return o}class Oa extends Wa{constructor(){super(...arguments);ae(this,"geometry",new Ge(Ge.TYPE_LINES))}setLandmarks(o,i){this.dispose(o);const r=this.geometry,l=[];for(let d of i)l.push({a_position:[d.point[0],d.point[1],d.point[2]],a_color:[d.visibility,0,1-d.visibility,1]});const n=[...K(8,6,5,4,0,1,2,3,7),...K(10,9),...K(12,24,23,11,12),...K(12,14,16),...K(11,13,15),...K(24,26,28),...K(23,25,27),...K(16,18,20,16,22),...K(15,17,19,15,21),...K(28,32,30,28),...K(27,29,31,27)];r.setVertices(l),r.indices=n}dispose(o){o.disposeGeometry(this.geometry)}render(o){o.uniform("u_mMatrix",this.matrix),o.drawGeometry(this.geometry)}}var Ha=`#version 300 es\r
\r
